...
public class EmpregadoProfessor extends Empregado {
    ...
    protected final double valorHora = 39.50;
    ...
    protected double calculaSalario(int numHoras) {
        return numHoras * (titulo == Titulacao.GRADUADO ? (valorHora) : 
                (titulo == Titulacao.POSGRADUADO ? (valorHora + (valorHora * 0.1))
                : (titulo == Titulacao.MESTRE ? (valorHora + (valorHora * 0.3)) :
